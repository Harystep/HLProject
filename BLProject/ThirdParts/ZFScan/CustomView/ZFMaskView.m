...
- (void)addUI{
    ...
    if ([[UIApplication sharedApplication] statusBarOrientation] == UIInterfaceOrientationLandscapeLeft || [[UIApplication sharedApplication] statusBarOrientation] == UIInterfaceOrientationLandscapeRight) {
        ...
        self.hintLabel.center = CGPointMake(self.maskView.center.x, self.maskView.center.y + (self.frame.size.height * ZFScanRatio) * 0.5 + 5);
        //左上
...
//        self.hintLabel.center = CGPointMake(self.maskView.center.x, 120);
        self.hintLabel.center = CGPointMake(self.maskView.center.x, self.maskView.center.y + (self.frame.size.width * ZFScanRatio) * 0.5 + 50);
