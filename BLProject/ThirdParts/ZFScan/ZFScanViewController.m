...
- (void)addUI{
    ...
    //返回按钮
    CGFloat back_width = 44;
    CGFloat back_height = 44;

    self.backButton = [UIButton buttonWithType:UIButtonTypeSystem];
    self.backButton.frame = CGRectMake(0, 0, back_width, back_height);
    [self.backButton setImage:[[UIImage imageNamed:@"leftWitheArrow"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] forState:UIControlStateNormal];
    ...
    self.backButton.center = CGPointMake(22, 42);
    self.backHintLabel.center = CGPointMake(52, 42);
//
//    //手电筒
