...
#python autobuild.py -w ../BLProject.xcworkspace -s BLProject -m 打包
...
USER_KEY = "08b7b7c900c0f95e11d52dc87bb7b523"
API_KEY = "5f6b1894efcf0095ff2965546dfd15a0"
#设置从蒲公英下载应用时的密码
PYGER_PASSWORD = "" 
# 蒲公英更新描述
PGYDESC = "new package"
...
def getIpaPath(exportPath,schema):
	# cmd = "ls %s" %(exportPath)
	# process = subprocess.Popen(cmd, stdout=subprocess.PIPE, shell=True)
	# (stdoutdata, stderrdata) = process.communicate()
	# ipaName = stdoutdata.strip()
    # ipaName = schema+".ipa"
	ipaPath = exportPath + "/" + schema+'.ipa'
	return ipaPath
